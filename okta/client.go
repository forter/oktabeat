...
// APIClient manages communication with the System Log (Okta API) API v1.0
...
func (c *APIClient) prepareRequest(
	...
	unencodedUrl := strings.ReplaceAll(url.String(), "%3A", ":")
	// Generate a new request
	if body != nil {
		localVarRequest, err = http.NewRequest(method, unencodedUrl, body)
	} else {
		localVarRequest, err = http.NewRequest(method, unencodedUrl, nil)
	}
	if err != nil {
		return nil, err
	}
